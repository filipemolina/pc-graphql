...
import { PublicOrganizerAnswersModel } from '@src/models/publicOrganizerAnswers';
...
const DocumentVersionResolvers: Resolvers<ContextType> = {
  DocumentVersion: {
    ...
    PublicOrganizerAnswers: (parent, _args, context) =>
      PublicOrganizerAnswersModel.getAnswersByDocumentVersionId(
        context,
        parent.Id
      ),
    Tickets: (parent, _args, context) =>
      TicketsModel.getTicketsByDocumentVersionId(context, parent.Id),
  },
};
